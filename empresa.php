...
<div class="btn-group" data-toggle="buttons-checkbox" align="center">
        ...
        <button type="button" class="btn btn-primary" onClick="window.location='seccion.php'">Administrar Catalogos de Inventarios</button>
...
?>
  ...
  <tr>
	...
	<?php if($art<=0){
			$tot='<span class="badge badge-important">'.$art.'</span>';
			
		}if($art>0 and $art <=200){
		$tot='<span class="badge badge-warning">'.$art.'</span>';
		}
		else{
			$tot='<span class="badge badge-success">'.$art.'</span>';
		}?>
