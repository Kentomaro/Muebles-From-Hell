...
<table width="00%" border="0" class="table table-hover">
  <tr class="info">
    ...
    <td width="30%"><strong>Descripcion del Producto</strong></td>
    <td width="15%"><strong>Valor Unitario</strong></td>
    <td width="10%"><strong><center>Cant.</center></strong></td>
  ...
  <tr>
	...
	if(($dato['exitencia']-$dato['cant'])>0){
	 ...
	 ?></center></td>
    <td> 
    <button type="button" class="btn btn-danger" onClick="window.location='php_eliminar.php?id=<?php echo $dato['cod']; ?>'"><i class="icon-minus-sign"></i> Remover</button>
    </td>
  <?php } ?>
...
<table width="100%" border="0">
  <tr>
    ...
    <td width="36%">
    	<div align="right">
    	  <pre style="font-size:24px">Total: <?php $can=mysql_query("SELECT SUM(importe) as neto FROM caja_tmp where usu='$usuario'");
  ...
  <tr>
    ...
    <div class="well" style="max-width: 400px; margin: 0 auto 10px;">
        <div align="center">
        <a href="#myContado" role="button" class="btn btn-success" data-toggle="modal"><i class=" icon-shopping-cart"></i>Pagar</a>
        </div>
    </div>
    <?php } ?>
    </td>
