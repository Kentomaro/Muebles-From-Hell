...
<table width="80%" border="0">
          ...
          <ul class="nav" role="navigation">
            ...
            <li class="dropdown">
              ...
              <ul class="dropdown-menu" role="menu" aria-labelledby="drop2">
				...
				<li role="presentation"><a role="menuitem" tabindex="-1" href="reporte_fecha.php" target="admin"><i class="icon-th-list"></i> 
                Listado Venta</a></li>
               <!--  <li role="presentation" class="divider"></li>
  ...
  <tr >
    <td ><div style="padding:0px;webkit-border-radius: 20px;-moz-border-radius: 20px;border-radius: 20px;margin:0 auto;overflow:hidden;"><iframe  src="empresa.php" frameborder="0" scrolling="auto" name="admin" width="100%" height="500"></iframe></div></td>
  </tr>
  <tr>
    <td>
