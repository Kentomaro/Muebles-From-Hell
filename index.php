...
<body>
 ...
 <div class="container">
      <form name="form1" method="post" action="" class="form-signin">
        ...
        <input type="password" name="contra" class="input-block-level" placeholder="Contrase&ntilde;a">
        <button onClick="myFunction()" class="btn btn-large btn-primary" type="submit">Iniciar</button>
        <p>&nbsp;</p>
<?php
...
$act="1";
		if(!empty($_POST['usuario']) and !empty($_POST['contra'])){
			...
			if($dato=mysql_fetch_array($can)){
				...
				if($act=="1"){echo '<div class="alert alert-error" align="center">Usuario y Contrase&ntilde;a Incorrecta</div>';}else{$act="0";}
			}
		}else{
